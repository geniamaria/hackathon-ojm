        ...
        <form method="POST" action="" class="flex flex-col gap-4 mb-10">
            <div class="ml-4 flex flex-col gap-[2px] w-[90%] mx-auto">
                ...
                <input 
                    ...
                    name="name" 
                    requred
                    class="w-full h-[46px] bg-zinc-100 rounded-[10px] border border-green-900 px-1 outline-none focus:outline-none focus:border-2"
                >
            </div>
            <div class="ml-4 flex flex-col gap-[2px] w-[90%] mx-auto">
                ...
                <div class="flex flex-row gap 1">
                    <input 
                        ...
                        required
                        disabled
                        class="w-[59px] h-[46px] opacity-60 bg-zinc-100 px-1 rounded-[10px]"
                        value="+258"
                    >
                    <input 
                        type="number" 
                        ...
                        name="cell" 
                        requred
                        class="w-[90%] h-[46px] bg-zinc-100 rounded-[10px] border border-green-900 px-1 outline-none focus:outline-none focus:border-2"
                    >
                </div>
            </div>
            <div class="ml-4 flex flex-col gap-[2px] w-[90%] mx-auto">
            ...
            <div class="ml-4 flex flex-col gap-[2px] w-[90%] mx-auto">
                ...
                <textarea
                    required
                    name="address"
                    class="w-full h-[347px] bg-zinc-100 rounded-[10px] border border-green-900 px-1 outline-none focus:outline-none focus:border-2"
                ></textarea>
            </div>
            <div class="ml-4 flex flex-col gap-[2px] w-[90%] mx-auto">
